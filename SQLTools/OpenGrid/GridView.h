...
private:
    ...
    void DoFileSave (BOOL);

public:
    //! Sets current subwindow name in the grid (for example: "Statistics Window" or "Bind Window").
    void SetVisualAttributeSetName (const std::string&);
    //! Gets current subwindow name.
    const std::string& GetVisualAttributeSetName () const;

    afx_msg void OnInitMenuPopup (CMenu* pPopupMenu, UINT nIndex, BOOL bSysMenu);
    afx_msg void OnGridOutputOptions ();
    afx_msg void OnGridOutputSaveAndOpen ();
    ...
    afx_msg void OnGridClear ();   
    afx_msg void OnUpdate_GridClear (CCmdUI* pCmdUI);
