...
// CConnectionBar
/*
IMPLEMENT_DYNAMIC(CConnectionBar, CToolBar)
*/
...
BOOL CConnectionBar::Create (CWnd* pParent, UINT id)
{
	...
	{
        TRACE0("CConnectionBar::Create: CreateEx failed\n");
		return FALSE;
	}
	...
	{
        TRACE0("CConnectionBar::Create: m_wndLabel.CreateEx failed\n");
		return FALSE;
	}
...
/*
BEGIN_MESSAGE_MAP(CConnectionBar, CToolBar)
END_MESSAGE_MAP()
*/

// CConnectionBar message handlers
