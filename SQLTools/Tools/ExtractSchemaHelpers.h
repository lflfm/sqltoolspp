...
public:
    ...
    FILE* OpenFile (const std::string&, FileList::EStage = FileList::esFist, const char* mode = "wt");

    // Parameters override OpenFile parameters before EndSingleStream call.
    void BeginSingleStream (const std::string&, FileList::EStage = FileList::esFist, const char* mode = "wt");
...
/// optimal view creation order builder /////////////////////////////////////
    ...
    void build_optimal_view_order (const OraMetaDict::Dictionary& dict, const char* schema, 
                                   OciConnect&, std::vector<const OraMetaDict::DbObject*>& result);
