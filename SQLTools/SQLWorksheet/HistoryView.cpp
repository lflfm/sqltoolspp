...
void CHistoryView::AddStatement (time_t startTime, const std::string& connectDesc, const std::string& sqlSttm)
{
    m_pHistorySource->AddStatement(startTime, connectDesc, sqlSttm);
