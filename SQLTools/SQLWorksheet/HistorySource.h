...
public:
    ...
    void AddStatement (time_t startTime, const string& connectDesc, const string& sqlSttm);
    // method for HistoryFileManager
    void LoadStatement (const string& startTime, const string& connectDesc, const string& sqlSttm, bool atTop = false);

protected:
    static const int TIME_COLUMN = 0;
    static const int CONNECT_COLUMN = 1;
    static const int STATEMENT_COLUMN = 2;
