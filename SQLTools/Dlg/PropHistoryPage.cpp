...
void CPropHistoryPage::DoDataExchange (CDataExchange* pDX)
{
    ...
    _ASSERTE(m_settings.m_HistoryAction == SQLToolsSettings::HistoryAction::Copy
        || m_settings.m_HistoryAction == SQLToolsSettings::HistoryAction::Paste
        || m_settings.m_HistoryAction == SQLToolsSettings::HistoryAction::ReplaceAll);
