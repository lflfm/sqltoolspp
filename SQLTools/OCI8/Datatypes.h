...
public:
    bool m_skipped;
    static string m_unsupportedStr;
    static string m_skippedStr;
};
...
protected:
    ...
    LobVar (Connect&, ELobSubtype, int limit);
...
{
public:
    CLobVar (Connect& connect, int limit) : LobVar(connect, elsCLob, limit) {}
    //void MakeTemporary ();
};
...
protected:
    ...
    string m_dateFormat;
public:
    static string m_defaultDateFormat; // "%Y.%m.%d %H:%M:%S"
};
