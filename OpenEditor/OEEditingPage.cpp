  ...
  m_manager(manager)
{
    ...
    */
    ...
    m_HomeGotoFirstColumn = settings->GetHomeGotoFirstColumn() ? TRUE : FALSE;
...
void COEEditingPage::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_OE_HOME_DEFAULT, m_HomeGotoFirstColumn);
...
BOOL COEEditingPage::OnApply()
{
    try { EXCEPTION_FRAME;
        ...
        settings->SetHomeGotoFirstColumn(m_HomeGotoFirstColumn ? true : false, false);
